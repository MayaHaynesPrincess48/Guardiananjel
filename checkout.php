                    ...
                    <div class="chk-box-rit">
                        <div class="chk-rit-prc-box">
                            ...
                            <div class="cart-sec1 dsplay">
                                <div class="nt-slt" id="cartBox"><span class="nt-txt">You have not selected any
                                        product...</span></div>
                            </div>
                        </div>
                        ...
                        <div class="chk-post-logo">
                            ...
                            Your Order Is Estimated To Arrive by <span class="red-c"><b>
                                    <script type="text/javascript">getDate(1);</script>
                                </b></span>
                        </div>
                        ...
                        <form role="form" action="thankyou.php" id="frmOrder" method="post" class="pageForm">
                            ...
                            <div class="frmBox">
                                ...
                                <div class="input-box">
                                    ...
                                    <input type="email" class="input-flds h5-email" name="email" id="email"
                                        placeholder="E-mail" value="" required maxlength="96" />
                                </div>

                                <div class="input-box">
                                    <img src="images/ic3.png" alt="ic3" class="fldicon">
                                    <input type="text" class="input-flds h5-phone" name="phone" id="phone"
                                        placeholder="Phone Number" value="" required maxlength="12" data-mask="phone" />
                                </div>

                                <div class="input-box">
                                    <img src="images/ic4.png" alt="ic6" class="fldicon">
                                    <input type="text" class="input-flds" name="shippingAddress1" id="shippingAddress1"
                                        placeholder="Address" value="" required maxlength="64" />
                                </div>

                                <div class="input-box">
                                    <img src="images/ic6.png" alt="ic7" class="fldicon">
                                    <input type="text" class="input-flds" name="shippingCity" id="shippingCity"
                                        placeholder="City" value="" required maxlength="32" />
                                </div>

                                <div class="input-box hlf">
                                    <img src="images/ic5.png" alt="ic1" class="fldicon">
                                    <select class="selcet-fld fl-select" name="shippingState" id="shippingState"
                                        required>
                                ...
                                <div class="input-box hlf fr">
                                    ...
                                    <input type="tel" class="input-flds h5-zip" name="shippingZip" id="shippingZip"
                                        placeholder="Zip Code" value="" required maxlength="5">
                                </div>
                            ...
                            <div class="chk-payment-box">
                                ...
                                <div class="shipaddress" style="display:none;">
                                    ...
                                    <div class="input-box hlf">
                                        <img src="images/ic1.png" alt="" class="fldicon">
                                        <input type="text" class="input-flds" name="billingFirstName"
                                            id="billingFirstName" placeholder="First Name" value="" required
                                            maxlength="64" />
                                    </div>
                                    <div class="input-box hlf fr">
                                        <img src="images/ic1.png" alt="" class="fldicon">
                                        <input type="text" class="input-flds" name="billingLastName"
                                            id="billingLastName" placeholder="Last Name" value="" required
                                            maxlength="64" />
                                    </div>

                                    <div class="input-box">
                                        <img src="images/ic4.png" alt="ic6" class="fldicon">
                                        <input type="text" class="input-flds" name="billingAddress1"
                                            id="billingAddress1" placeholder="Address" value="" required
                                            maxlength="64" />
                                    </div>

                                    <div class="input-box">
                                        <img src="images/ic6.png" alt="ic7" class="fldicon">
                                        <input type="text" class="input-flds" name="billingCity" id="billingCity"
                                            placeholder="City" value="" required maxlength="32" />
                                    </div>
                                    ...
                                    <div class="input-box hlf fr">
                                        <img src="images/ic7.png" alt="ic7" class="fldicon">
                                        <input type="tel" class="input-flds h5-zip" name="billingZip" id="billingZip"
                                            placeholder="Zip" value="" required maxlength="8">
                                    </div>
                                </div>
                                ...
                                <div class="input-box payfld">
                                    <input type="text" name="creditCardNumber" id="creditCardNumber" value=""
                                        ...
                                        onkeydown="return onlyNumbers(event,'cc')" class="h5-ccno field-all" />
                                </div>
                                ...
                                <div class="input-box hlf payfld cvv">
                                    <input type="tel" class="field-all" placeholder="Security code" id="cvv"

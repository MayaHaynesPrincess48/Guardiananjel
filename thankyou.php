...
<div class="inr-cont thank-pg">
    <div class="container">
        ...
        <div class="comn-hdng">Thank You For <span>Your Order!</span> </div>
        <p class="comn-para">Your order is being processed. Please look for an email receipt.</p>
        <p class="comn-para">Your estimated delivery date is on or before
            <?php echo date("l F j, Y", strtotime("+ 4 days")); ?>.
        </p>
    </div>
</div>
